...
/// @notice Permit721 handles signature-based transfers.
/// @dev Users must approve Permit721 before calling any of the transfer functions.
contract Permit721 is ISignatureTransfer, EIP712 {
    ...
    function _permitTransferFrom(
        ...
        if (requestedTokenId != permit.permitted.tokenId) {
        ...
        IERC721(permit.permitted.token).safeTransferFrom(
            owner,
            transferDetails.to,
            requestedTokenId
        );
